...
| The single end-of-batch redraw still walks every loaded focus with no viewport culling | `ui/canvas.py:150` (`_do_redraw`) | Viewport culling | fixed in phase 8 (see the viewport-culling row below for what is/isn't fixed) | TBD |
