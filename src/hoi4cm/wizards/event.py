...
def open_event_wizard(app):
    ...
    # ── Output generation ─────────────────────────────────────────────
    # Renderers live in `_generators.py` so they can be unit-tested
    # headlessly (see issue #51 and docs/dev/wizards.md).
    ...
    def _save_to_mod():
        ...
        if MOD.edit_scripted_loc_file:
            sloc_blocks = _generators.build_event_scripted_loc_blocks(
