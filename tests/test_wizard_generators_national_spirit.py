...
def test_build_national_spirit_uses_german_localisation_path():
    out = build_national_spirit_output(mod_id="TAG_s", loc_language="german")

    assert "localisation/german/TAG_s_l_german.yml" in out
